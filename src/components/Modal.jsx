...
function Modal({ setOpenModal }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-[1px] flex items-center justify-center z-50">
            {isSending ? (
                <Loader />
            ) : user ? (
                <div className="modalContainer rounded-sm shadow-md">
                    ...
                    <div className="">
                        <h1 className="font-Belanosima font-normal text-[20px] text-center">
                            {" "}
